...
module.exports = class extends Generator {
  ...
  _overwriteBot() {
    ...
    const pkgJsonTypeScript = {
      ...
      dependencies: {
        "@retaildevcrews/adaptive-card-transformer": "^0.2.2",
      },
      devDependencies: {
        "@types/node": "^10.17.27",
      },
  ...
  install() {
    if (this.answersAdapter.bot == "createBot") {
      ...
      this.log(
        "To manually integrate the Adaptive Card Transformer into your bot, please refer to steps found in https://github.com/retaildevcrews/wd-bot/blob/main/docs/HowToIntegrate.md"
      );
    }
    this.npmInstall();
  }
